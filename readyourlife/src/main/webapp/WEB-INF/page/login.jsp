...
<body>
	...
	<center>
	<div style="padding-bottom:250px;background-color:yellow">
						...
						<fieldset>
							...
							<label>Enter E-Mail Id</label>
								<input class="form-control" placeholder="E-mail"
									name="j_username" type="email" style="margin-left:33.3%;margin-right:33.3%;width:400px">
							</div>
							<div class="form-group">
							<label>Enter Password</label>
								<input class="form-control" placeholder="Password"
									name="j_password" type="password" style="margin-left:33.3%;margin-right:33.3%;width:400px">
							</div>
							<div class="checkbox">
							...
							<div id="button">
								<button type="submit" class="btn btn-sm btn-success"
									style="margin-right: 79px; margin-left: 60px; background-color:blue">Login</button>
								<a href="<c:url value="/customer/registration"/>"
									class="btn btn-sm btn-success" style="background-color:blue">Register</a>
							</div>
						</fieldset>
					</form>
				  </center>
